...
LOG_EXPECTED="minitalk-tester/expected.log"

echo -n > ./$LOG_SERVER
./server > ./$LOG_SERVER &
PID=$!
echo "Starting Minitak tests"
echo +++++++++++++++++++
echo "'tail -f $LOG_SERVER' to see it live"
sleep 3
echo +++++++++++++++++++
echo "Server PID: $PID"
echo
echo "Test 1 - dots - 1000 Char"
echo
time ./client $PID \
"....................................................................................................
....................................................................................................
...
....................................................................................................
...................................................................................................."
diff -q -s <(sed -n '2,11p' $LOG_SERVER) <(sed -n '2,11p' $LOG_EXPECTED)
...
echo
time ./client $PID ""
diff -q -s <(sed -n '12p' $LOG_SERVER) <(sed -n '12p' $LOG_EXPECTED)

sleep 1
echo
echo "Test 3 - Tux - 6463 char"
echo
time ./client $PID \
"                                           @@@@@@@@@@@@@                                            
                                        @@@@@@@@@@@@@@@@@@@@                                        
 ...
 *++++++=======------------------==+*#@@@@@@@@@@@@@@@@@@@@@@@@@@@@#*+==------=====++***             
       **++++++++=====---------===+*##@@@            @@@@@@@@@@@@@##*++=======++++**#               
              ******++++========++*##                           @@%##***++++++****#                 
                     #****+++++**##%                               %%####****####                   
                          #######%                                   %%%%#####                      "
diff -q -s <(sed -n '13,76p' $LOG_SERVER) <(sed -n '13,76p' $LOG_EXPECTED)

sleep 1
echo
echo "Test 4 - 20'000 char"
echo "credit to ThibaudM13"
echo "https://github.com/ThibaudM13/minitalk-Tester"
echo
time ./client $PID \
"
...
TTTTTTTT  OOOOOOOOO  UU     UU  RRRRRRRR             EEEEEEEEE  IIIIIIIIII  FFFFFFFFF  FFFFFFFFF  EEEEEEEEE  LL
 ...
 -----------------------------------------------------------------------------------------------------------------                        
"
diff -q -s <(sed -n '77,238p' $LOG_SERVER) <(sed -n '77,238p' $LOG_EXPECTED)

sleep 1
echo
echo "Test 5 - UTF8 - 10881 char"
echo "source: https://gist.github.com/janlelis/72f9be1f0ecca07372c64cf13894b801"
echo
time ./client $PID \
"# Emoji 11.0
...
diff -q -s <(sed -n '238,576p' $LOG_SERVER) <(sed -n '238,576p' $LOG_EXPECTED)
